...
list_acc = {}
OUTPUT_FILE = "Report_Restruk_DPK"
...
,"E:\\Projects\\LUA Script\\BRI Report\\Data\\LW321PNSingleRow%5FImpact%5FCorona%5FV2 ALLMIKRO.csv","E:\\Projects\\LUA Script\\BRI Report\\Data\\LW321PNSingleRow MIKRO1.csv",0)
...
for k, v in pairs(list_acc) do
	...
	if prev_uker ~= uker then
		list_fd[uker] = io.open(uker.." "..OUTPUT_FILE..".csv", "w")
		list_fd[uker]:write(table.concat({'Rekening', 'Nama Debitur', 'Tipe', 'Outstanding', 'Tunggakan(hari)', 'Officer', 'Rencana Tindak Lanjut','Waktu Penyelesaian'}, output_sep)..'\n')
	end
	
	--list_fd[uker]:write(table.concat({format_account(v[1]), v[2], v[3], format_number(v[4]), v[5], v[6],'Restrukturisasi/Penagihan/GS/Penjualan Agunan','Minggu 1/2/3/4/5'}, output_sep)..'\n')
	list_fd[uker]:write(table.concat({format_account(v[1]), v[2], v[3], v[4], v[5], v[6],'Restrukturisasi/Penagihan/GS/Penjualan Agunan','Minggu 1/2/3/4/5'}, output_sep)..'\n')
	prev_uker = uker
end

for k, v in pairs(list_fd) do
	v:close()
end
