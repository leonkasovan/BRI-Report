...
local txt_ag_no_app_format = "B.%d/KC/OPS/"..os.date("%m/%Y")	-- replace / => %2F	form2
...
-- sl_ag_type_ojk=1&
local sl_ag_type_ojk = "2"

-- sl_ag_tipe_usaha=999&
local sl_ag_tipe_usaha = "170"

-- poscode_jenisusahalp=525400&
local poscode_jenisusahalp = "542209"

-- txt_ag_usaha=DAGANG+SEPATU&
local txt_ag_usaha = "Restoran"

-- txt_ag_siup=&
local txt_ag_siup = "9120100980018"

-- txt_ag_owner=ADI&
 local txt_ag_owner = "Aliuyanto"

-- txt_ag_no_ktp=3304042507920002&
-- local txt_ag_no_ktp = field[4]

-- txt_ag_NPWP_1=&
local txt_ag_NPWP_1 = "01"

-- txt_ag_NPWP_2=&
local txt_ag_NPWP_2 = "995"

-- txt_ag_NPWP_3=&
local txt_ag_NPWP_3 = "838"

-- txt_ag_NPWP_4=&
local txt_ag_NPWP_4 = "8"

-- txt_ag_NPWP_5=&
local txt_ag_NPWP_5 = "062"

-- txt_ag_NPWP_6=&
local txt_ag_NPWP_6 = "000"
...
local sl_ag_almt_kec = "31.74.03"

-- sl_ag_almt_kel = 31.75.06.1005&
local sl_ag_almt_kel = "31.74.03.1002"
...
function GeneratePostData(field)
	...
	mytable[#mytable+1] = "txt_ag_owner="..txt_ag_owner
...
, "F:\\QRIS HTTP\\qris_data_solaria.csv"
